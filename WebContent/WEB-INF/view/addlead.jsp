		           ...
		           <form:form id="addLeadForm" modelAttribute="theLead" action="saveLead" class="well">
	                ...
	                <div class="form-group">
	                 ...
	                 <div class="form-group">
	                   ...
	                   <form:errors path="cancerHistRelation" />
	                 </div>
	                 <div class="form-group">
	                   ...
	                   <form:errors path="cancerHistAge" />
	                 </div>
	                 <div class="form-group">
	                    <label>Gender</label>
	                    <div>
	                 ...
	                 <div class="form-group">
	                   ...
	                   <form:errors path="custWeight" cssClass="validation-error" />
	                 </div>
	                 <div class="form-group">
	                   <label>Height</label>
	                   <form:input type="text" path="custHeight" class="form-control" placeholder="Enter Height"/>
	                   <form:errors path="custHeight" cssClass="validation-error" />
	                 </div>
	                 <div class="form-group">
