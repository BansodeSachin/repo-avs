...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Lead Information</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="leadInfo">Lead Information</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Lead Information<small>Manage Site Pages</small></h1>
          </div>
        </div>
      </div>
    </header>
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li><a href="index">Dashboard</a></li>
          <li class="active">Lead Information</li>
        </ol>
      </div>
    </section>
